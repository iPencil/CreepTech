package com.creepgaming.creeptech.compat;
...
public class WailaCompatibility implements IWailaDataProvider {
    ...
    public static void load(IWailaRegistrar registrar) {
        ...
        if (!loaded) {
            registrar.registerHeadProvider(INSTANCE, BlockEnergyStorage.class);
            registrar.registerBodyProvider(INSTANCE, BlockEnergyStorage.class);
            registrar.registerTailProvider(INSTANCE, BlockEnergyStorage.class);
            loaded = true;
        }
    }
    ...
    public static void register(){
        if (registered)
            return;
        registered = true;
        FMLInterModComms.sendMessage("Waila", "register", "com.creepgaming.creeptech.compat.WailaCompatibility.load");
    }
